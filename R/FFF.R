...
FFF=function(Year,Month,Day){
  ...
  urlcontent=xml2::read_html(url)
  friend1=(rvest::html_text(rvest::html_node(x=urlcontent,css="#main > div > div > div > article > div:nth-child(7) > div > ul > ul.bullet-green > li:nth-child(1) > a")))
  friend2=rvest::html_text(rvest::html_node(x=urlcontent,css = "#main > div > div > div > article > div:nth-child(7) > div > ul > ul.bullet-green > li:nth-child(2) > a"))
  friend3=rvest::html_text(rvest::html_node(x=urlcontent,css = "#main > div > div > div > article > div:nth-child(7) > div > ul > ul.bullet-green > li:nth-child(3) > a"))
  foe1=(rvest::html_text(rvest::html_node(x=urlcontent,css="#main > div > div > div > article > div:nth-child(7) > div > ul > ul.bullet-red > li:nth-child(1) > a")))
  foe2=rvest::html_text(rvest::html_node(x=urlcontent,css = "#main > div > div > div > article > div:nth-child(7) > div > ul > ul.bullet-red > li:nth-child(2) > a"))
  famous1=(rvest::html_text(rvest::html_node(x=urlcontent,css="#main > div > div > div > article > div:nth-child(45) > div > ul > li:nth-child(1)")))
  famous2=rvest::html_text(rvest::html_node(x=urlcontent,css = "#main > div > div > div > article > div:nth-child(45) > div > ul > li:nth-child(2)"))
  famous3=rvest::html_text(rvest::html_node(x=urlcontent,css = "#main > div > div > div > article > div:nth-child(45) > div > ul > li:nth-child(3)"))
